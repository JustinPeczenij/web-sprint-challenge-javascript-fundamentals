...
// nestedFunction can access the variable outside of its lexical environment because of closures. myFunction is the parent and nestedFunction is the child.
// The child can reach out to it's parent and access the properties from its parent.
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    return array.forEach(item => item.animal_name, item.scientific_name)
  }
  ...
  */
  ...
  function USApop(array){
    const population = array.reduce((accumulator, index) => accumulator + index['population'], 0)
    return population
  }
